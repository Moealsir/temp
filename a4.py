...
# retreives the emails perfectly
...
def authorize(user_id):
    ...
    try:
        ...
        if existing_token:
            return 'User already authorized. You can now check your emails.'
        ...
        # create a state file inside the user's directory
...
def oauth2callback():
    try:
        ...
        with open(os.path.join(STORAGE_DIR, state), 'r') as f:
            data = json.load(f)
        ...
        return 'Authorization successful. You can now check your emails.'
    except Exception as e:
